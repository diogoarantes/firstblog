...
def post_list(request):
	...
	return render(request,'posts_templates/posts_list.html',{'posts': posts})
...
def post_edit_list(request):
	posts = Post.objects.filter(published_date__lte=timezone.now()).order_by('published_date')
	return render(request,'posts_templates/posts_edit_list.html',{'posts': posts})
...
def post_edit(request, id):
	...
	return render(request,'posts_templates/posts_edit.html',{'form': form})